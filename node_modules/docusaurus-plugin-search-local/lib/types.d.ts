...
export type PluginConfig = Omit<PluginOptions, 'docsRouteBasePath' | 'blogRouteBasePath' | 'docsDir' | 'blogDir' | 'ignoreFiles'> & {
...
export type SearchSourceFn = (input: string, callback: (results: SearchResult[]) => void) => void;
export type SearchAnalyticsFn = (query: string, results?: SearchResult[]) => void;
